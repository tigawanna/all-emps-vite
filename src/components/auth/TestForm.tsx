...
export const TestForm: React.FC<EmailPasswordSignupProps> = ({}) => {
    const [error, setError] = React.useState({name: "main", message:""})
    const queryClient = useQueryClient();
    const navigate = useNavigate()
    const form_input: FormOptions[] = [
        { field_name: "email", field_type: "text", default_value: "",required:true },
        { field_name: "password", field_type: "password", default_value: "", required: true },
        { field_name: "passwordConfirm", field_type: "password", default_value: "", required: true },
        { field_name: "avatar", field_type: "file", default_value: "", required: true },
  ]  
